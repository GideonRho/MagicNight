...
namespace MagicNight.Migrations
{
    ...
    [Migration("20220722180107_AddGuestUsers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MagicNight.Models.Database.Rolls.CommanderRollLobby", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("CommanderRollLobbies");
                });
            ...
            modelBuilder.Entity("MagicNight.Models.Database.Rolls.Values.CommanderRollLobbyEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("CommanderRollLobbyEntries");
                });
            ...
            modelBuilder.Entity("MagicNight.Models.Database.Sets.SetCard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MagicNight.Models.Database.Rolls.CommanderRollLobby", b =>
                {
                    b.HasOne("MagicNight.Models.Database.Rolls.CommanderRoll", "Roll")
                        .WithMany()
            ...
            modelBuilder.Entity("MagicNight.Models.Database.Rolls.Values.CommanderRollLobbyEntry", b =>
                {
                    b.HasOne("MagicNight.Models.Database.Rolls.CommanderRollLobby", "Lobby")
                        .WithMany("Entires")
